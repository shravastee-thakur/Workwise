...
const Hero = () => {
  return (
    <div>
      ...
      <div className="flex w-[90%] md:w-[40%] mx-auto shadow-lg border border-gray-300 rounded-md overflow-hidden mt-6">
        <input
          type="text"
          placeholder="Find Your Dream Job"
          className="flex-1 px-3 py-2 outline-none border-none text-sm md:text-base"
        />
        <button className="bg-cyan-700 text-white px-4 py-2 text-sm md:text-base hover:bg-cyan-800 transition">
          Search
        </button>
      </div>
    </div>
